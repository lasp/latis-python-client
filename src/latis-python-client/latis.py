...
def _datasetWillUseVersion3(baseUrl, dataset, preferVersion2) -> bool:
...
class Dataset:
    ...
    def select(self, target="time", start="", end="", inclusiveStart=True, inclusiveEnd=False) -> "Dataset":
        """
